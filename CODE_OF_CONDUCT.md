...
One project-specific note, because this is a security tool and the line is worth drawing
explicitly: **publishing a working bypass before the maintainer has had a chance to respond is a
conduct problem as well as a disclosure problem.** [`SECURITY.md`](SECURITY.md) has the private
channel and the expected timelines.
...
maintainer. This repository has one private channel: the **Security** tab → *Report a
vulnerability*, which creates a private advisory visible only to you and the maintainer. Use it,
and say in the first line that the report is a conduct matter rather than a vulnerability. You may
also contact [@williamzujkowski](https://github.com/williamzujkowski) directly on GitHub.
